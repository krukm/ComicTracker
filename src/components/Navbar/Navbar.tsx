...
export default function Navbar() {
  ...
  return (
    <div
      className={`${rubikGlitch.className} flex justify-between items-center w-full h-20 px-4 text-blue-900 bg-yellow-600 fixed nav`}
    >
      <div>
        <h1 className="text-3xl md:text-5xl ml-2">Comics Collected</h1>
      </div>
